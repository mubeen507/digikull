...
import digistall from '../../images/land-logo.png'
import "./signUp.scss"
        ...
        <div className="Login-Container">
            <div className="login-header">
                ...
                <div className="signup-login-container">
                    <Link to="/signup" className="link"><p className="nav-link active">Signup</p></Link>
                    <Link to="/login" className="link"><p className="nav-link">Login</p></Link>
                </div>
            </div>
